...
class SkelletonOptions extends AbstractOptions
{
	...
	const REGISTRATION_EMAIL_MODERATOR            = 0b0000001;
	const REGISTRATION_EMAIL_WELCOME              = 0b0000010;
	const REGISTRATION_EMAIL_WELCOME_CONFIRM_MAIL = 0b0000100;
	const REGISTRATION_EMAIL_CONFIRM_MAIL         = 0b0001000;
	const REGISTRATION_EMAIL_CONFIRM_MODERATOR    = 0b0010000;
	const REGISTRATION_EMAIL_ACTIVATED            = 0b0100000;
	const REGISTRATION_EMAIL_DISABLED             = 0b1000000;
